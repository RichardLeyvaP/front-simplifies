    ...
    <v-menu activator="#menu-activator">
      <v-list>
        ...
        <div v-if="item.tittle === 'Solicitud'">
          ...
          <v-list-item-subtitle :class="{ 'highlight': item.state2 === 2, 'accent': item.state2 !== 2 }">{{
            item.description }}</v-list-item-subtitle> <!-- Título del elemento de la lista -->
        </v-list-item>
      </v-list>
    </v-menu>
        ...
        <v-card-text class="mt-2 mb-2">
          <v-form ref="form" v-model="valid" enctype="multipart/form-data">
              ...
              <v-row>
                <v-col cols="12">
                  <v-text-field v-model="password" label="Contraseña"
                    ...
                    hint="Haz clic en el ícono para mostrar/ocultar la contraseña" variant="underlined"></v-text-field>
                </v-col>
              </v-row>
              <v-row>
                <v-col cols="12">
                ...
                <v-col cols="12">
                  <v-text-field v-model="confirmNewPassword" label="Confirmar Nueva Contraseña"
            ...
            <v-card-actions>
              ...
              <v-btn color="#F18254" variant="flat" @click="shangePassword" :loading="loading"
        ...
        if (!LocalStorageService.getIsLocked()) {
          ...
          try {
            ...
            const result = await handleRequest({
              endpoint: 'notification-professional-web',
              method: 'GET',
...
<style>
.highlight {
  /* Color de texto primario en Vuetify por defecto */
  opacity: 0.6;
}
