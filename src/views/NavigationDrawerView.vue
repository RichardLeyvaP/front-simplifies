...
export default {
  data: () => ({
    ...
    reportes: [
      { icon: "mdi-finance", title: "Ganancias Sucursal", to: "branch-winner", value: "branch-winners", permission: "view_branch_earnings" },
      { icon: "mdi-finance", title: "Ganancias Company", to: "company-winner", value: "company-winners", permission: "view_company_earnings" },
      { icon: "mdi-finance", title: "Monto generado por Profesional", to: "branch-winner-professional", value: "branch-winner-professional", permission: "view_professional_earnings" },
      { icon: "mdi-finance", title: "Historial del Cliente", to: "client-history", value: "client-history", permission: "view_client_history" },
