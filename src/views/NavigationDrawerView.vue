...
<template>
  <v-card style="height: 100%; display: flex; flex-direction: column;">
        <template v-slot:prepend>
          ...
          :prepend-avatar="`${this.$axios.defaults.baseURL}images/${this.imageBusiness}`" :title="this.titulo" :subtitle="this.subtitle">
          </v-list-item>
        </template>
...
export default {
  data: () => ({
    ...
    listItems: [
      ...
      //{ icon: "mdi-clipboard-text", title: "Reservaciones", to: "reservation-professional", value: "Reservaciones por profesional", permission: "view_reservation_professional" },
    ...
    administracion: [
      { icon: "mdi-domain", title: "Empresa", to: "busines", value: "busines", permission: "view_business_general" },
    ...
    { icon: "mdi-list-box-outline", title: "Asignar servicios a una Sucursal", to: "branch-service-professional", value: "branch-service-professional", permission: "view_service_branch" },          
