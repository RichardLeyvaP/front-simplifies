    ...
    <v-toolbar color="#F18254">
      <v-row align="center">
        <v-col cols="12" md="8" class="grow ml-4">
          <span class="text-h8"> <strong>Reservas por profesional</strong></span>
        </v-col>
      </v-row>
    </v-toolbar>
    <v-container>
              ...
              <v-autocomplete
                ...
                <template v-slot:item="{ props, item }">
                  <v-list-item
                    v-bind="props"
                    :prepend-avatar="
                      `${this.$axios.defaults.baseURL}images/${item.raw.image_url}`"
...
export default {
  ...
  data: () => ({
    ...
    events: [],
    professionals: [],
    colors: ["blue", "green", "orange", "grey darken-1", "indigo", "deep-purple", "cyan"],
    dialogfreeday: false,
    freedays: [],
