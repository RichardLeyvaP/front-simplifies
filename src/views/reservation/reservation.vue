  ...
  export default {
    ...
    methods: {
      onCardGiftSelected(value) {
        ...
        axios
          .get('https://testapi.simplifies.cl/api/show-value', {
            params: {
              code: value.data
            }
          })
      ...
      requestDelete() {
        ...
        axios
          .post('https://testapi.simplifies.cl/api/order-destroy', request)
          .then(() => {
            this.initialize();
      ...
      requestCancel(item) {
        ...
        axios
          .put('https://testapi.simplifies.cl/api/order', request)
          .then(() => {
            this.initialize();
            this.showDetails(this.reservation_resf)
      ...
      initialize() {
        ...
        axios
          .get('https://testapi.simplifies.cl/api/branch-reservations', {
            params: {
      ...
      showDetails(item) {
        ...
        axios
          .get('https://testapi.simplifies.cl/api/car_services', {
            params: {
      ...
      deleteItemConfirm() {
        ...
        console.log(request);
        axios
          .post('https://testapi.simplifies.cl/api/reservation-destroy', this.data)
          .then(() => {
            this.initialize();
      ...
      saveBox() {
        {
          ...
          axios
            .put('https://testapi.simplifies.cl/api/box', this.data)
            .then(() => {
