            ...
            <v-col cols="12" md="4">
              ...
              <v-card class="mx-auto" max-width="400">
                <v-img class="align-end text-white" height="300"
                  :src="'https://testapi.simplifies.cl/api/images/' + results.imageLook" cover>
                  <v-card-title>
                ...
                <v-card-text class="pt-2">
                  ...
                  <v-avatar elevation="3" class="mx-auto" max-width="60" max-height="60">
                    <v-img :src="'https://testapi.simplifies.cl/api/images/' + results.image_url" alt="Imagen"></v-img>
                  </v-avatar>
                  ...
                  <v-list-item v-for="service in results.services" :key="service.id" :title="service.name"
                    ...
                    <template v-slot:prepend>
                      <v-avatar class="mr-5" elevation="3" color="grey-lighten-4">
                        <v-img :src="'https://testapi.simplifies.cl/api/images/' + service.image_service" alt="image"></v-img>
                      </v-avatar>
                    </template>
                  </v-list-item>
                </v-list>
              ...
              <v-card class="mx-auto" max-width="450">
                ...
                <v-list lines="two" item-props>
                  <v-list-item v-for="product in results.products" :key="product.id" :title="product.name"
                    ...
                    <template v-slot:prepend>
                      <v-avatar class="mr-5" elevation="3" color="grey-lighten-4">
                        <v-img :src="'https://testapi.simplifies.cl/api/images/' + product.image_product" alt="image"></v-img>
                      </v-avatar>
                    </template>
                  </v-list-item>
                </v-list>
...
export default {
  ...
  mounted() {
    ...
    axios
        .get('https://testapi.simplifies.cl/api/client-index-autocomplete')
        .then((response) => {
