      ...
      <v-container>
        <v-row align="center">
          <v-col cols="12" md="8" class="grow ml-4">
            <span class="text-subtitle-1"> <strong>Monto generado por Sucursales por (Día, Mes o Período)</strong></span>
          </v-col>
          <v-spacer></v-spacer>
          <v-col cols="12" md="3">
  ...
  computed: {
    formTitle() {
      if (this.editedIndex === 2) {
        ...
        return 'Monto generado por Sucursales en el período ' + format(this.input, "yyyy-MM-dd") + '-' + format(this.input2, "yyyy-MM-dd");
      }
