...
export default {
  ...
  methods: {
    ...
    initialize() {
      ...
      LocalStorageService.setIsLocked(true);
      axios
        .get('http://127.0.0.1:8000/api/branch-prueba')
        .then((response) => {
    ...
    showStores(item) {
      ...
      console.log(item.id);
      axios
        .get('http://127.0.0.1:8000/api/branchstore-show', {
          params: {
            branch_id: item.id
          }
        })
    ...
    showAddStores() {
      LocalStorageService.setIsLocked(true);
      axios
        .get('http://127.0.0.1:8000/api/branchstore-show-notInt', {
          params: {
            branch_id: this.branchSelect.id
          }
        })
    ...
    showAddAssociates() {
      LocalStorageService.setIsLocked(true);
      axios
        .get('http://127.0.0.1:8000/api/associated-show', {
          params: {
            branch_id: this.branchSelect.id
          }
        })
