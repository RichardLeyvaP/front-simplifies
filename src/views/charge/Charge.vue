          ...
          <v-dialog v-model="dialogPermissions" fullscreen transition="dialog-bottom-transition">
            <v-card>
              ...
              <v-card-text class="mt-2 mb-2">
                ...
                <v-data-table :headers="headers2" :items="chargePermissions" :search="search2" class="elevation-1"
              ...
              <v-card-text class="mt-2 mb-2">
                <v-form ref="form" v-model="valid" enctype="multipart/form-data">
                  <v-container>
                    <v-row>
                      <v-col cols="12" md="12">
                        <v-autocomplete :no-data-text="'No hay datos disponibles'" v-model="permission_id"
                          :items="permissions" label="Permisos" prepend-icon="mdi-lock" item-title="name"
                              ...
                              <v-list-item-subtitle >
                                ...
                                <v-tooltip location="bottom" max-width="600">
                                  <template v-slot:activator="{ props: tooltipProps }">
                                    <div class="description-text" v-bind="tooltipProps">
...
/* Override estilos de Vuetify */
.constrained-autocomplete :deep(.v-autocomplete__content) {
  width: auto !important;
  min-width: unset !important;
  max-width: min(600px, calc(100vw - 48px)) !important;
}

.constrained-autocomplete :deep(.v-list-item__subtitle) {
  margin: 0 !important;
  width: 100%;
}
</style>