        ...
        <v-data-table :headers="headers" :items="results" :search="search" class="elevation-1"
          ...
          <template v-slot:item.name="{ item }">
            ...
            <v-avatar class="mr-5" elevation="3" color="grey-lighten-4">
              <v-img :src="'https://testapi.simplifies.cl/api/images/' + item.course_image" alt="image"></v-img>
            </v-avatar>
            {{ item.name }}
          </template>
          ...
          no-data-text="No hay datos disponibles" no-results-text="No hay datos disponibles" :loading="loadingStudent" loading-text="Cargando datos...">
                ...
                <template v-slot:item.name="{ item }">
                  <v-avatar elevation="3" color="grey-lighten-4" size="large">
                    <v-img :src="'https://testapi.simplifies.cl/api/images/' + item.student_image" alt="image"></v-img>
                  </v-avatar>
                  {{ item.name}}
                </template>
...
export default {
  ...
  methods: {
    ...
    openModal(imageUrl) {
      ...
      var img = new Image();
      img.src = 'https://testapi.simplifies.cl/api/images/' + imageUrl;
      img.onload = () => {
        this.selectedImageUrl = 'https://testapi.simplifies.cl/api/images/' + imageUrl;
      };
      img.onerror = () => {
    ...
    showStudents(item) {
      ...
      //console.log(item.id);
      axios
        .get('https://testapi.simplifies.cl/api/course-student-show', {
          params: {
            course_id: item.id
          }
        })
    ...
    showAddStudent() {
      LocalStorageService.setIsLocked(true);
      axios
        .get('https://testapi.simplifies.cl/api/student-show', {
          params: {
    ...
    saveS() {
      ...
      axios
        .post('https://testapi.simplifies.cl/api/course-student', this.data)
        .then(() => {
          this.$nextTick(() => {
            this.editedStudent = Object.assign({}, this.defaultStudent)
          })
    ...
    saveStatus() {
      ...
      axios
        .post('https://testapi.simplifies.cl/api/course-student-update', formData)
        .then(() => {
          this.dialogAddStudent = false;
        }).finally(() => {
          LocalStorageService.setIsLocked(false);
    ...
    requestDelete() {
      ...
      axios
        .post('https://testapi.simplifies.cl/api/course-student-destroy', request)
        .then(() => {
          this.dialogRequest = false;
        }).finally(() => {
          LocalStorageService.setIsLocked(false);
    ...
    initialize() {
      ...
      LocalStorageService.setIsLocked(true);
      axios
        .get('https://testapi.simplifies.cl/api/course-show', {
          params: {
    ...
    deleteItemConfirm() {
      ...
      axios
        .post('https://testapi.simplifies.cl/api/course-destroy', request)
        .then(() => {
        }).finally(() => {
          LocalStorageService.setIsLocked(false);
    ...
    save() {
      ...
      if (this.editedIndex == 2) {
        ...
        axios
          .post('https://testapi.simplifies.cl/api/course-update', formData)
          .then(() => {
            this.imgMiniatura = '';
            this.file = null;
          }).finally(() => {
        ...
        axios
          .post('https://testapi.simplifies.cl/api/course', formData)
          .then(() => {
            this.imgMiniatura = '';
            this.file = null;
          }).finally(() => {
    ...
    showProducts(item) {
      ...
      console.log(item.id);*/
      axios
        .get('https://testapi.simplifies.cl/api/productsale-show', {
          params: {
      ...
      /*axios
      .get('https://testapi.simplifies.cl/api/course-student-product-show',{
        params: {
          course_id: item.id
        }
      })
    ...
    showAddProduct() {
      LocalStorageService.setIsLocked(true);
      axios
        .get('https://testapi.simplifies.cl/api/products-academy-show', {
          params: {
            enrollment_id: this.courseSelect.enrollment_id
          }
        })
    ...
    saveProduct() {
      ...
      if (this.editedIndex == 3) {
        ...
        console.log(this.data);*/
        axios
          .post('https://testapi.simplifies.cl/api/productsale', this.data)
          .then(() => {
            this.dialogAddProduct = false;
            this.student_id = '',
              this.product_id = '';
    ...
    deleteProduct() {
      ...
      axios
        .post('https://testapi.simplifies.cl/api/productsale-destroy', request)
        .then(() => {
          this.dialogRequestProduct = false;
          this.productsale_id = '';
        }).finally(() => {
    ...
    showAddProfessional(item) {
      ...
      this.courseSelect = item;
      axios
        .get('https://testapi.simplifies.cl/api/course-professional', {
          params: {
            course_id: this.courseSelect.id
          }
        })
    ...
    saveProfessional() {
      ...
      console.log(this.data);
      axios
        .post('https://testapi.simplifies.cl/api/course-professional', this.data)
        .then(() => {
    ...
    showAdddialogProfessionals() {
      LocalStorageService.setIsLocked(true);
      axios
        .get('https://testapi.simplifies.cl/api/course-professional-show-Notin', {
          params: {
            course_id: this.courseSelect.id
          }
        })
    ...
    requestDeleteProfessional() {
      ...
      axios
        .post('https://testapi.simplifies.cl/api/course-professional-destroy', request)
        .then(() => {
    ...
    StateSave() {
      ...
      axios
        .post('https://testapi.simplifies.cl/api/course-student-update2', this.data)
        .then(() => {
          this.dialogUpdateState = false;
        }).finally(() => {
          LocalStorageService.setIsLocked(false);
