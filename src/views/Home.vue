            ...
            <v-card elevation="5" style="z-index:2; margin-top: -20px; border:0px">
              <v-card-text>
                <div>
                  <v-row>
                    <v-col cols="12" md="10">
                      <spam class="text-overline">Ingreso Mensual</spam>
                    </v-col>
                    <v-col cols="12" md="2">
            ...
            <v-card elevation="5" style="z-index:2; margin-top: -20px; border:0px">
              <v-card-text>
                <div>
                  <v-row>
                    <v-col cols="12" md="10">
                      <spam class="text-overline">Productos Vendidos</spam>
                    </v-col>
                    <v-col cols="12" md="2">
            ...
            <v-card elevation="5" style="z-index:2; margin-top: -20px; border:0px">
              <v-card-text>
                <div>
                  <v-row>
                    <v-col cols="12" md="10">
                      <spam class="text-overline">Servicios brindados</spam>
                    </v-col>
                    <v-col cols="12" md="2">
  ...
  <v-col cols="12">
    ...
    <v-dialog v-model="dialogServices" max-width="800px" transition="dialog-bottom-transition">
      <v-card>
        <v-toolbar color="#F18254">
          <v-col cols="12" md="9" class="grow ml-4">
            <span class="text-h8"> <strong>Servicios brindados</strong></span>
          </v-col>
          <v-spacer></v-spacer>
        </v-toolbar>
        <v-card elevation="2">
    ...
    <v-dialog v-model="dialogProducts" max-width="800px" transition="dialog-bottom-transition">
      <v-card>
        <v-toolbar color="#F18254">
          <v-col cols="12" md="9" class="grow ml-4">
            <span class="text-h8"> <strong>Productos vendidos</strong></span>
          </v-col>
          <v-spacer></v-spacer>
        </v-toolbar>
        <v-card elevation="2">
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { title: "Cantidad", key: "total_cant", sortable: true }
      ],
      headers1: [
  ...
  return formattedValue;
    ...
    const responseProducts = await axios.get('http://127.0.0.1:8000/api/car-products-services', {
      params: {
        branch_id: this.branch_id,
        business_id: this.business_id
      }
    ...
    this.serviceCant = this.services[0].cant;
    this.serviceCantAnt = this.services[0].cantAnt;
    const responseWeekWinner = await axios.get('http://127.0.0.1:8000/api/cars-winner-week', {
      params: {
        branch_id: this.branch_id,
        business_id: this.business_id
      }
    ...
    const responseReservations = await axios.get('http://127.0.0.1:8000/api/reservations-count-week', {
      params: {
        branch_id: this.branch_id,
        business_id: this.business_id
      }
    ...
    const responseMounth = await axios.get('http://127.0.0.1:8000/api/cars-winner-mounth', {
      params: {
        branch_id: this.branch_id,
        business_id: this.business_id
      }
