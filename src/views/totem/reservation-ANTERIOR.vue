                ...
                <v-sheet border>
                    <v-list>
                        <v-list-item-group v-model="professional" active-class="deep-purple--text text--accent-4">
                            <v-list-item  :prepend-avatar="'https://testapi.simplifies.cl/api/images/professionals/barber-aleatore.png' "
...
axios
  .get('https://testapi.simplifies.cl/api/professional-reservations-time' , {
            params: request
        })
        .then((response) => {
  ...
  return day ? day.day.toString().trim() : "";
        ...
        chargeCalendarsBranches() {
            axios
                .get(`https://testapi.simplifies.cl/api/schedule-show?branch_id=${this.branch_id}`)
                .then((response) => {
...
,
      ...
      /*  isProfessional(serviceId2) {
        ...
        chargeServices() {
            axios
                .get(`https://testapi.simplifies.cl/api/branchservice-show?branch_id=${this.branch_id}`)
                .then((response) => {
