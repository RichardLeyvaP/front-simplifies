  ...
  export default {
    ...
    initialize() {
      ...
      deleteItemConfirm() {
        ...
        axios
          .post('https://testapi.simplifies.cl/api/enrollment-destroy', request)
          .then(() => {
          }).finally(() => {
            LocalStorageService.setIsLocked(false);            
            this.initialize();
      ...
      save() {
        ...
        console.log(formData);
          axios
            .post('https://testapi.simplifies.cl/api/enrollment-updated', formData)
            .then(() => {
              this.file = null;
            this.imgMiniatura = '';
            }).finally(() => {              
        ...
        for (let key in this.editedItem) {
          ...
          axios
            .post('https://testapi.simplifies.cl/api/enrollment', formData)
            .then(() => {
              this.file = null;
            this.imgMiniatura = '';
            }).finally(() => {
    ...
    showStores(item){      
      ...
      this.editedIndex = 5;
        ...
        console.log(item.id);
        axios
          .get('https://testapi.simplifies.cl/api/enrollmentstore-show', {
            params: {
    ...
    showAddStores(){
      LocalStorageService.setIsLocked(true);
      axios
          .get('https://testapi.simplifies.cl/api/enrollmentstore-show-notIn', {
          params: {
    ...
    saveStore() {
      ...
      console.log(this.data);
      axios
        .post('https://testapi.simplifies.cl/api/enrollmentstore', this.data)
        .then(() => {
          this.dialogAddStore = false;
          this.store_id = '';
        }).finally(() => {       
    ...
    storeDelete() {
      ...
      axios
        .post('https://testapi.simplifies.cl/api/enrollmentstore-destroy', request)
        .then(() => {
          this.dialogRequestStore = false;
          this.store_id = '';
   ...
   /*//Asignar Productos
    showProducts(item){
      this.editedIndex = 3;
        ...
        console.log(item.id);
        axios
          .get('https://testapi.simplifies.cl/api/productstore-academy-show', {
            params: {
              enrollment_id: item.id
            }
          })
        ...
        axios
        .get('https://testapi.simplifies.cl/api/store-academy-show', {
          params: {
            enrollment_id: this.enrollment_id
          }
        })
      ...
      axios
        .get('https://testapi.simplifies.cl/api/product')
        .then((response) => {
