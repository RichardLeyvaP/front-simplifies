...
initialize() {
 ...
 axios
   .get('https://testapi.simplifies.cl/api/student')
   .then((response) => {
...
editItem(item) {
  this.file = null;
      var img = new Image();
      img.src = 'https://testapi.simplifies.cl/api/images/' + item.student_image;
      img.onload = () => {
        this.imgMiniatura = 'https://testapi.simplifies.cl/api/images/' + item.student_image;
      };
      img.onerror = () => {
        this.imgMiniatura = '';
      };
...
deleteItemConfirm() {
 ...
 axios
   .post('https://testapi.simplifies.cl/api/student-destroy', request)
   .then(() => {
    LocalStorageService.setIsLocked(false);
     this.initialize();
...
save() {
 ...
 if (this.editedIndex > -1) {
   ...
   axios
     .post('https://testapi.simplifies.cl/api/student-update', formData)
     .then(() => {
      LocalStorageService.setIsLocked(false);
       this.initialize();
   ...
   axios
     .post('https://testapi.simplifies.cl/api/student', formData)
     .then(() => {
      LocalStorageService.setIsLocked(false);
       this.initialize();
